...
(async () => {
    ...
    await getExtras();
      merchants = merchants.map((merchant, index) => {
        merchants[index].friendlyName = merchant.mainCategory !== undefined ? merchant.mainCategory.friendlyName : 'Sem Endereço';
        ...
        merchants[index].city = merchant.address !== undefined ? merchant.address.city : 'Sem Localização';
    ...
    fastcsv
      .write(merchants, { headers: true, encoding: 'utf-16le' })
      .pipe(ws);
})();